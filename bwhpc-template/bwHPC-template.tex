...
% For Xelatex/Lualatex and fonts XCharter (Charter), TeX Gyre Pagella (URW Palladio, Palatino) or heuristica (Utopia)
% \usepackage{fontspec}
% \setmainfont{XCharter}
% XCharter + Math
% \setmainfont[otfmath]{XCharter}
% For pdflatex inputenc and fonts XCharter (Charter), tgpagella (TeX Gyre Pagella, URW Palladio, Palatino) or heuristica (Utopia)
\usepackage[utf8]{inputenc}
\usepackage{XCharter}

% Language settings, please select one
% English
\input{../bwhpc-layout/english.tex}
% or German
% \input{../bwhpc-layout/german.tex}
